...
class DataReaderH36M(object):
    ...
    def read_2d(self):
        ...
        train_camera_name = self.dt_dataset['train']['camera_name'][::self.sample_stride]  # [N]
        test_camera_name = self.dt_dataset['test']['camera_name'][::self.sample_stride]  # [N]
        # map to [-1, 1]
        for idx, camera_name in enumerate(train_camera_name):
        ...
        for idx, camera_name in enumerate(test_camera_name):
            if camera_name == '54138969' or camera_name == '60457274':
                res_w, res_h = 1000, 1002
            elif camera_name == '55011271' or camera_name == '58860488':
                res_w, res_h = 1000, 1000
